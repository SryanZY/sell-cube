...
export default {
  ...
  methods: {
    ...
    _showShopCartList () {
      this.shopCartListComp = this.shopCartListComp || this.$createShopCartList({
        ...
        $events: {
          ...
          add: (el) => {
            this.shopCartStickyCom.drop(el)
          }
        }
      })
    ...
    _showShopCartSticky () {
      this.shopCartStickyCom = this.shopCartStickyCom || this.$createShopCartSticky({
        $props: {
          selectFoods: 'selectFoods',
      ...
      this.shopCartStickyCom.show()
    },
    _hideShopCartSticky () {
      this.shopCartStickyCom.hide()
    },
    pay (e) {
